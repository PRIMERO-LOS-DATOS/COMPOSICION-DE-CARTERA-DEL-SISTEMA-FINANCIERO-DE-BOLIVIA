...
handles$getDatEstFinByGroupAsfi_CalificacionPorDestinoCredito <- function(dat=NULL, by='ENTIDAD', yearInit = 2014, byClass = NULL, byEnts = NULL) {
    ...
    if (is.null(dat)) { 
        dat <- handles$getDatAsfiBasic_CalificacionPorDestinoCredito(yearInit = yearInit, 
                                                                     byClass = byClass, 
                                                                     byEnts = byEnts) 
    }
