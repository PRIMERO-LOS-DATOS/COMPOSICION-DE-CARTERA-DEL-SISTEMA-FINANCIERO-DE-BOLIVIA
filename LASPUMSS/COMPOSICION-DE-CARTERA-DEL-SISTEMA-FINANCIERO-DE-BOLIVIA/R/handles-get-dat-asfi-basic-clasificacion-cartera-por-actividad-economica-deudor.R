...
handles$getDatAsfiBasic_CalificacionCartActEcoDeudor<- function(yearInit = 2014, byClass = NULL, byEnts = NULL) {
    
    require(openxlsx)
    require(dplyr)
    
    rootFile <- 'FUENTES-DATOS/ESTADOS-FINANCIEROS-ASFI-WEB/data/COLOCACIONES/BBDD_CLASIFCARTERAACTIVIDADECONOMICA.xlsx'
